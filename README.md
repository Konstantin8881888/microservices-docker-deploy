...
## 4. Тестирование
    scripts\full-verification.bat
* По неизвестным, случайно происходящим причинам, notification-service может отображаться в тестах нерабочим, однако это не так. В тестах взаимодействий он работает.
